...
strbuf:	.space TEXT_SIZE	# Buffer for text
    	...
    	str_get("Input path to file for reading: ",file_name, NAME_SIZE) # Entering the file name from the console
   	...
   	mv s10 a4  # Save start of  result subsequence
    	...
    	str_get("Do you want to print the file data in the console? Y/N: ",answer, NAME_SIZE)
